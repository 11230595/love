...
<script type="text/javascript" src="${request.contextPath}/love/1/renxi/jscex-parser.js"></script>
<script type="text/javascript" src="${request.contextPath}/love/1/renxi/jscex-jit.js"></script>
<script type="text/javascript" src="${request.contextPath}/love/1/renxi/jscex-builderbase.min.js"></script>
<script type="text/javascript" src="${request.contextPath}/love/1/renxi/jscex-async.min.js"></script>
...
<audio autoplay="autopaly">
  <source src="${request.contextPath}/love/1/renxi.mp3" type="audio/mp3" />
</audio>
<div id="main">
  <div id="wrap">
    <div id="text">
      <div id="code"> <font color="#FF0000"> <span class="say">${template.uName!''}</span><br>
    ...
    <div id="clock-box"> <span class="STYLE1"></span><font color="#33CC00">${template.uName!''}，我喜欢你</font> <span class="STYLE1">已经是……</span>
      <div id="clock"></div>
    </div>
...
<script>
    (function(){
        ...
        var textAnimate = eval(Jscex.compile("async", function () {
		    ...
		    together.setFullYear(${year!2015},${month!1},${day!1}); 			//时间年月日
