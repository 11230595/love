...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="${request.contextPath}/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
...
================================================== -->
  <body>
    ...
    <script src="${request.contextPath}/bootstrap/dist/js/bootstrap.min.js"></script>
