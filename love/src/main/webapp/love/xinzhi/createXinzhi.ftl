      	...
      	<p class="lead">
	      	<div class="input-group" style="width:39%;">
	        	...
	        	<span class="input-group-addon"><code>${url!''}i/</code></span>
	         	<input type="text" required id="webCode" name="webCode" class="form-control" onblur="checkWebCode(this);" placeholder="访问域名，如：lisi">
	      	</div>
          ...
          <div class="container">
            <div class="carousel-caption" style="text-align:left;top: 55%;left:15%;color:#000;">
            	<form action="" class="form-horizontal"  role="form" id="f">
	              ...
	              <p>&nbsp;</p>
	              <p><input type="text" name="content" size="30" class="input"/><p>
	              <p><input type="text" name="content" size="40" class="input"/><p>
	              <p><input type="text" name="content" size="40" class="input"/><p>
	              <p><input type="text" name="content" size="40" class="input"/><p>
	              <p><input type="text" name="content" size="40" class="input"/><p>
	              <p><input type="text" name="content" size="40" class="input"/><p>
